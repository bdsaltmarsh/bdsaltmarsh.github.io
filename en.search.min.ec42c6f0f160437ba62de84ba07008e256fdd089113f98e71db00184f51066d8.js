...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.de54d9d4a309869327517d4ec954c7be9bfda9f8d28defcdb2063d4ed138384f.js',function(){input.required=false;search();});}
